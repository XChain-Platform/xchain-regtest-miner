...
function registerStringResponseTest() {
...
function registerNullResponseTest() {
...
function registerUndefinedResponseTest() {
...
function registerHtmlResponseTest() {
...
function registerAuthFailureTest() {
...
describe('Chaos: RPC Response Corruption & Auth Failure', function () {
    registerNodeHooks()
    describe('CE-04: RPC Returns Unexpected Data Shapes', registerStringResponseTest)
    describe('CE-04: RPC Returns Unexpected Data Shapes', registerNullResponseTest)
    describe('CE-04: RPC Returns Unexpected Data Shapes', registerUndefinedResponseTest)
    describe('CE-04: RPC Returns Unexpected Data Shapes', registerHtmlResponseTest)
})

describe('Chaos: RPC Response Corruption & Auth Failure', function () {
    registerNodeHooks()
    describe('CE-10: RPC Authentication Failure', registerAuthFailureTest)
})
