    ...
    static getBitcoinJsNetwork(networkName){
        switch(networkName){
            ...
            case "dogecoin-regtest":
                ...
                //
                // NOTE: dustThreshold (100000 koinu) IS consumed by fillMempool.
                // XChainRegtestMiner.js reads network.dustThreshold into coinDust to size
                // AMOUNT_FOR_EACH_ADDRESS and the per-output FEE.
                return {
                    "messagePrefix": '\x19Dogecoin Signed Message:\n',
                    "bip32": {
                       "public": 0x043587cf,
