    ...
    static getBitcoinJsNetwork(networkName){
        switch(networkName){
            ...
            case "dogecoin-regtest":
                ...
                // NOT the Dogecoin-testnet prefixes; addresses generated by the
                // running node won't decode under 0x71 and parsing fails.
                //
                // NOTE: dustThreshold (100000 koinu) is declared for reference but is
                // not consumed by fillMempool. Output sizing is delegated to regtest.conf
                // min-relay flooring. Do not wire dustThreshold into fillMempool amount
                // math without also updating AMOUNT_FOR_EACH_ADDRESS in XChainRegtestMiner.js.
                return {
                    "messagePrefix": '\x19Dogecoin Signed Message:\n',
                    "bip32": {
                       "public": 0x043587cf,
